...
\centering
  ...
  \begin{tabular}{l c c c p{2.5cm} }
    ...
    String & $str_n$ & String num & $channel_0$ & [1,6] \\\hline 
    ...
    Prev. interval & $pint_n$ & Semitones & $p_{-1}-p_0$ & [-60,60] \\
 	...
 	Narmour & $nar1_n$ & Label & $nar(p_{-1},p_0,p_1)$ & [P, D, R, ID]\\
    & $nar2_n$ &  & $nar(p_{-2},p_{-1},p_0)$ & [VR, IR, VP, IP] \\
    ...
    Simultaneous notes & $sim_n$ & Number & $simult_0$ & [0,+$\infty$] \\ \hline
